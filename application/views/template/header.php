...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/dropzone.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/uppy.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/jquery.steps.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/jquery.timepicker.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/quill.snow.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backend/css/dataTables.bootstrap4.css">
